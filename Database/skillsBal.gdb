...
BaseSkillPassiveMod overrides BaseSkillPassive
{
...
SkillBonusAttackPerDexWeaponMasterBal overrides SkillBonusAttackPerDexWeaponMaster
{
	StatChangePerAttributeChange	0.15 // 1.0
}

SkillBonusDamageMultPerStrWeaponMasterBal overrides SkillBonusDamageMultPerStrWeaponMaster
{
	StatChangePerAttributeChange	0.001 // 0.002
}

SkillManaGenWeaponMasterBal overrides SkillManaGenWeaponMaster
{
	PowerGainOnHit		1.0 // 1.5
	PowerGainOnCrushingBlow		2.0
}

SkillPowerStrikePerLevelBal overrides SkillPowerStrikePerLevel
{
	DamageMultPhysical	0.08 // 0.2
	
}

SkillPowerStrikeBal overrides SkillPowerStrike
{
...
SkillWhirlwindPerLevelBal overrides SkillWhirlwindPerLevel
{
	DamageMultPhysical	0.08 // 0.1
	Power		2 // 1
}

SkillWhirlwindBal overrides SkillWhirlwind
{
	Power		20 // 10
	ReuseTime	40 // bal: super skill
	
	DamageMultPhysical	-1.00 // -0.299999
}

SkillDevastatingBlowPerLevelBal overrides SkillDevastatingBlowPerLevel
{
	DamageMultPhysical	0.04 // 0.1
	Power	2 // 1
}

SkillDevastatingBlowBal overrides SkillDevastatingBlow
{
	Power		18 // 5
	ReuseTime	5.5 // added
...
SkillAdrenalinePerLevelBal overrides SkillAdrenalinePerLevel
{
	ReuseTime	3 // 2.0
	Power	2 // 1
}

SkillAdrenalineBal overrides SkillAdrenaline
{
	Power		25 // 20
	ReuseTime	30 // 120
}

SkillPerfectStrikePerLevelBal overrides SkillPerfectStrikePerLevel
{
	DamageMultPhysical	0.06 // 0.2
	DynamicStatMultAttack	0.05 // added
}

SkillPerfectStrikeBal overrides SkillPerfectStrike
{
	Power		18 // 10
	ReuseTime	5.5 // added
	
	DamageMultPhysical	0.15 // 0.2
	DynamicStatMultAttack	0.05 // 2.0
}

SkillArmsMasteryPerLevelBal overrides SkillArmsMasteryPerLevel
{
	StatChangeAttack	10.0
	StatMultMinDamage	0.02 // 0.04
	StatMultMaxDamage	0.02 // 0.04
	StatChangeMaxPower	-3	// bal: balance out strength of mastery
}

SkillArmsMasteryBal overrides SkillArmsMastery
{
	StatMultMinDamage	0.02 // 0.04
	StatMultMaxDamage	0.02 // 0.04
	StatChangeMaxPower	-3	// bal: balance out strength of mastery
...
SkillSwordMasteryPerLevelBal overrides SkillSwordMasteryPerLevel
{
	StatMultMinDamage	0.04 // 0.08
	StatMultMaxDamage	0.04 // 0.08

	DynamicStatChangeDeepWounds	0.16	 // added
	StatChangeMaxPower	-3	// balance out strength of mastery
}

SkillSwordMasteryBal overrides SkillSwordMastery
{
	StatMultMinDamage	0.04 // 0.08
	StatMultMaxDamage	0.04 // 0.08
...
SkillAxeMasteryPerLevelBal overrides SkillAxeMasteryPerLevel
{
	StatMultMinDamage	0.04 // 0.08
	StatMultMaxDamage	0.04 // 0.08

	DynamicStatChangeCriticalHit	0.15 // added
	DynamicStatMultCriticalHit	0 // 0.04
	StatChangeMaxPower	-3	// bal: balance out strength of mastery
}

SkillAxeMasteryBal overrides SkillAxeMastery
{
	StatMultMinDamage	0.04 // 0.08
	StatMultMaxDamage	0.04 // 0.08
	...
	WeaponType2	WeaponAxeTwoHanded
}

SkillMaceMasteryPerLevelBal overrides SkillMaceMasteryPerLevel
{
	StatMultMinDamage	0.04 // 0.08
	StatMultMaxDamage	0.04 // 0.08

	DynamicStatChangeCrushingBlow	0.15 // added
	DynamicStatMultCrushingBlow	0 // 0.05
	StatChangeMaxPower	-3	// bal: balance out strength of mastery
}

SkillMaceMasteryBal overrides SkillMaceMastery
{
	StatMultMinDamage	0.04 // 0.08
	StatMultMaxDamage	0.04 // 0.08
	...
	WeaponType2	WeaponMaceTwoHanded
}

SkillBleedPerLevelBal overrides SkillBleedPerLevel
{
	DynamicStatChangeDeepWounds	0.5 // added
	DynamicStatMultDeepWounds	0 // 0.15
}

SkillBleedBal overrides SkillBleed
{
	DynamicStatChangeDeepWounds	0.5 // added
...
SkillBonusAttackPerDexGladiatorBal overrides SkillBonusAttackPerDexGladiator
{
	StatChangePerAttributeChange	0.15 // 1.0
}

SkillBonusDamageMultPerStrGladiatorBal overrides SkillBonusDamageMultPerStrGladiator
{
	StatChangePerAttributeChange	0.001 // 0.002
}

SkillManaGenGladiatorBal overrides SkillManaGenGladiator
{
	PowerGainWhenHit	1.5 // 1.0
	PowerGainOnHit		0.75 // added
}

SkillFocusArmorPerLevelBal overrides SkillFocusArmorPerLevel
{
	Power	 1 // 0
}

SkillFocusArmorBal overrides SkillFocusArmor
{
	Power	 20 // 0
...
SkillFocusDamagePerLevelBal overrides SkillFocusDamagePerLevel
{
	Power	1 // 0
}

SkillFocusDamageBal overrides SkillFocusDamage
{
	CostIncreasePerLevel	2	// Like a passive	
}

SkillFocusRagePerLevelBal overrides SkillFocusRagePerLevel
{
	Power	1 // 0
}

SkillFocusRageBal overrides SkillFocusRage
{
	Power		20 // 0
...
SkillSavageStrikePerLevelBal overrides SkillSavageStrikePerLevel
{
	DynamicStatChangeCrushingBlow	2.0 // 0
	DynamicStatMultCrushingBlow	0 // 0.3
	DamageMultPhysical	0.22 // 0.2
}

SkillSavageStrikeBal overrides SkillSavageStrike
{
	Power		15 // 10
	ReuseTime	5.5 // 0
	
	DynamicStatChangeCrushingBlow	5.0 // 0
	DynamicStatMultCrushingBlow	0 // 0.3
	DamageMultPhysical	0.088 // 0.6
}

SkillEnragePerLevelBal overrides SkillEnragePerLevel
{
	Power		2 // 0
	ReuseTime	2 // 0
}

SkillEnrageBal overrides SkillEnrage
{
	Power		25 // 0
}

SkillCleavePerLevelBal overrides SkillCleavePerLevel
{
	DamageMultPhysical	0.08 // 0.135
	Power		2
}

SkillCleaveBal overrides SkillCleave
{
	MaxRange	100 // 125
	Power		18 // 8
	ReuseTime	15 // bal: super skill
	
	DamageMultPhysical	-0.4 // -0.1349999

	// Sharp weapons only! (added)
	WeaponType	WeaponSword
	WeaponType	WeaponSwordTwoHanded
	WeaponType	WeaponAxe
	WeaponType	WeaponAxeTwoHanded
...
SkillCrushingBlowPerLevelBal overrides SkillCrushingBlowPerLevel
{
	DynamicStatChangeCrushingBlow	0.45 // 0
	DynamicStatMultCrushingBlow	0 // 0.2
}

SkillCrushingBlowBal overrides SkillCrushingBlow
{
	DynamicStatChangeCrushingBlow	0.45 // 0
	DynamicStatMultCrushingBlow	0 // 0.2
}

SkillBerserkPerLevelBal overrides SkillBerserkPerLevel
{
	DamageMultPhysical	0.1 // 0.15
	DynamicStatMultAttack	0.08 // 0.15
	Power		1 // 0.5
}

SkillBerserkBal overrides SkillBerserk
{
	Power		15 // 4
	ReuseTime	3.8 // 0
	DynamicStatMultAttack	0.08 // 0.25
	
	BaseCost	1 // added
}

SkillBloodLustPerLevelBal overrides SkillBloodLustPerLevel
{
	ReuseTime	4 // 0
}

SkillBloodLustBal overrides SkillBloodLust
{
  // changed from passive

	Base		BaseSkillDefense // BaseSkillPassive

	Power		0 // added
	TotalTime	1.0 // added
	ReuseTime	60 // added

	SoundName		Sounds/Player/FocusRage.wav // added
	
	SkillType	Buff // added
	
	StatusEffect	StatusEffectBloodLust
}

SkillRuptureArmorBal overrides SkillRuptureArmor
{
	Power		15 // 10
	TotalTime	1.0 // 1.15 ? appears twice
}
...
SkillBonusDamageMultPerStrDefenderBal overrides SkillBonusDamageMultPerStrDefender
{
	StatChangePerAttributeChange	0.001 // 0.002
}

SkillManaGenDefenderBal overrides SkillManaGenDefender
{
	PowerGainWhenBlock	2.5 // 2
	PowerGainWhenParry	2.5 // 2
	PowerGainOnHit	0.75 // 0
}

SkillRevengePerLevelBal overrides SkillRevengePerLevel
{
	DamageMultPhysical		0.12 // 0.3
	DynamicStatChangeCriticalHit	2.0 // 0
	DynamicStatMultCriticalHit	0 // 0.6
	
	Power	2 // 0
}

SkillRevengeBal overrides SkillRevenge
{
	Power		18 // 3
	ReuseTime	5.1 // 2

	DynamicStatChangeCriticalHit	5.0 // 0
	DynamicStatMultCriticalHit	0 // 0.6
}

SkillRipostePerLevelBal overrides SkillRipostePerLevel
{
	DamageMultPhysical		0.08 // 0.5
	DynamicStatChangeCriticalHit	2.5 // 0
	DynamicStatMultCriticalHit	0 // 0.4
	
	Power	2 // 0
	ReuseTime	0.4 // 0
}

SkillRiposteBal overrides SkillRiposte
{
	Power		20 // 3
	ReuseTime	5.0 // 2

	DamageMultPhysical		0.2 // 0.5
	DynamicStatChangeCriticalHit	6.25 // 0
	DynamicStatMultCriticalHit	0 // 0.4
}

SkillRetaliationPerLevelBal overrides SkillRetaliationPerLevel
{
	DamageMultPhysical		0.112 // 0.25
	DynamicStatChangeCriticalHit	1.0 // 0
	DynamicStatMultCriticalHit	0 // 0.05

	PowerAdded 0 // 2 CHECK: undo this?
	Power	2 // 0
}

SkillRetaliationBal overrides SkillRetaliation
{

	Power		18 // 0
	PowerAdded	0 // 10 CHECK: undo this?
	ReuseTime	6.3 // 10

	DamageMultPhysical		0.28 // 0.25
	DynamicStatChangeCriticalHit	2.5 // 0
	DynamicStatMultCriticalHit	0 // 0.05
}

SkillShieldBashDefenderPerLevelBal overrides SkillShieldBashDefenderPerLevel
{
	DamageMultPhysical	0.072 // 0.3
	
}

SkillShieldBashDefenderBal overrides SkillShieldBashDefender
{
	Power		18 // 5
	TotalTime	1.3 // 1
	ReuseTime	6.1 // 10

	DamageMultPhysical	0.18 // 0.3
}

SkillGutPerLevelBal overrides SkillGutPerLevel
{
	MinCharLevel	5 // added
	
	Power		2 // 1
}

SkillGutBal overrides SkillGut
{
	Power		18 // 10
	TotalTime	0.7 // 1.45

  // Only works with these weapons (added)
	WeaponType	WeaponDagger
	WeaponType	WeaponSword
	WeaponType	WeaponSwordTwoHanded
	
	MinCharLevel	0 // added
}


SkillPlateArmorPerLevelBal overrides SkillPlateArmorPerLevel
{
	StatMultArmor		0.1 // 0.05
}

SkillPlateArmorBal overrides SkillPlateArmor
{
	StatMultArmor		0.1 // 0.05
}

SkillBlockPerLevelBal overrides SkillBlockPerLevel
{
	Power		2 // 1
	ReuseTime	-0.3 // added
}

SkillBlockBal overrides SkillBlock
{
	Power		25 // 15
	ReuseTime	12.0 // 6
}
...
SkillBonusAttackPerDexAssassinBal overrides SkillBonusAttackPerDexAssassin
{
	StatChangePerAttributeChange	1.5 // 1.25
}

SkillBonusDamageMultPerStrAssassinBal overrides SkillBonusDamageMultPerStrAssassin
{
	StatChangePerAttributeChange	0.0006 // 0.002
}

SkillManaGenAssassinBal overrides SkillManaGenAssassin
{
	PowerGainOnHit		0.5 // 0
	PowerGainOnKill		3.0 // 6
	PowerGainOnCriticalHit	2.0 // 3
}

SkillRupturePerLevelBal overrides SkillRupturePerLevel
{
	DynamicStatChangeDeepWounds		1.5 // 0
	DynamicStatMultDeepWounds	0 // 0.25
	DamageMultPhysical		0.06 // 0.15
}

SkillRuptureBal overrides SkillRupture
{
	...
	DynamicStatChangeDeepWounds	3.75 // 0
	DynamicStatMultDeepWounds	0 // 0.4
	DamageMultPhysical		0.15 // 0.25

	// Only sword-like weapons (added)
	WeaponType	WeaponDagger
	WeaponType	WeaponSword
	WeaponType	WeaponSwordTwoHanded
}

SkillLethalBlowPerLevelBal overrides SkillLethalBlowPerLevel
{
	DamageMultPhysical		0.072 // 0.15
	DynamicStatChangeCriticalHit	1.1 // 0
	DynamicStatMultCriticalHit	0 // 0.1
}

SkillLethalBlowBal overrides SkillLethalBlow
{
	ReuseTime	6.3 // 0
	
	DamageMultPhysical		0.18 // 0.5
	DynamicStatChangeCriticalHit	2.75 // 0
	DynamicStatMultCriticalHit	0 // 0.3
}

SkillPreciseStrikePerLevelBal overrides SkillPreciseStrikePerLevel
{
	DynamicStatChangeCriticalHit	0.8 // 0
	DynamicStatMultCriticalHit	0 // 0.05
	DamageMultPhysical		0.1 // 0.25
	
	Power	2 // 0
}

SkillPreciseStrikeBal overrides SkillPreciseStrike
{
	Power	25 // 0
	ReuseTime	6.1 // 1.0
	
  PowerAdded  0 // 5 Disable until regen is worked out

	DynamicStatChangeCriticalHit	2.0 // 0
	DynamicStatMultCriticalHit	0 // 0.2
	DamageMultPhysical		0.25 // 0.4
}

SkillViperVenomPerLevelBal overrides SkillViperVenomPerLevel
{
	MinCharLevel	5 // added
}

SkillViperVenomBal overrides SkillViperVenom
{
	Power		18 // 15
	TotalTime	0.5 // 1.35
...
SkillSpotVulnerabilityPerLevelBal overrides SkillSpotVulnerabilityPerLevel
{
	DynamicStatChangeDeepWounds	0.4 // 0
	DynamicStatMultDeepWounds	0 // 0.03
}

SkillSpotVulnerabilityBal overrides SkillSpotVulnerability
{
	DynamicStatChangeDeepWounds	0.4 // 0
	DynamicStatMultDeepWounds	0 // 0.03
}

SkillDeathBlowPerLevelBal overrides SkillDeathBlowPerLevel
{
	DamageMultPhysical		0.08 // 0.25
	DynamicStatChangeCriticalHit	0.6 // 0
	DynamicStatMultCriticalHit	0 // 0.05

	ProjMinDamage	8 // 15
	ProjMaxDamage	20
	ProjDamageInflation		0.2 // 0.05
	
	MinCharLevel	5 // added
	Power	2 // 0
}

SkillDeathBlowBal overrides SkillDeathBlow
{
	ReuseTime	6.8 // 0
	
	// TODO: This needs work once regen is worked out
	PowerAdded		10
	PowerAddedOnKill	1

	DamageMultPhysical		0.2 // 0.5
	DynamicStatChangeCriticalHit	1.5 // 0
	DynamicStatMultCriticalHit	0 // 0.1
...
SkillCriticalStrikePerLevelBal overrides SkillCriticalStrikePerLevel
{
	DamageMultPhysical	0.12 // 0.25
	DynamicStatChangeStunningBlow	0.15 // 0
	
	Power		2 // 0
}

SkillCriticalStrikeBal overrides SkillCriticalStrike
{
	Power		25 // 0
	...
	DamageMultPhysical	0.3 // 0.75
	DynamicStatChangeStunningBlow	0.15 // 0
	ProjMinDamage	5
	ProjMaxDamage	13 // 10
	ProjDamageInflation		0.1 // 0.04
...
SkillChargedStrikeBal overrides SkillChargedStrike
{
	ProjMinDamage	10 // 15
	ProjMaxDamage	20 // 25
...
SkillDeadlyAimPerLevelBal overrides SkillDeadlyAimPerLevel
{
	DynamicStatChangeCriticalHit	0.5 // 0
	DynamicStatMultCriticalHit	0 // 0.06
}

SkillDeadlyAimBal overrides SkillDeadlyAim
{
	DynamicStatChangeCriticalHit	0.5 // 0
	DynamicStatMultCriticalHit	0 // 0.06
}

SkillRoquePrecisionPerLevelBal overrides SkillRoquePrecisionPerLevel
{
	StatMultAttack	0.05 // 0.07

	DynamicStatChangeCriticalHit	0.2 // 0
	DynamicStatChangeDeepWounds	0.3 // 0
	DynamicStatMultCriticalHit	0 // 0.02
	DynamicStatMultDeepWounds	0 // 0.04
}

SkillRoquePrecisionBal overrides SkillRoquePrecision
{
	StatMultAttack	0.05 // 0.07
...
SkillBonusAttackPerDexTricksterBal overrides SkillBonusAttackPerDexTrickster
{
	StatChangePerAttributeChange	0.75 // 0.5
}

SkillBonusDefensePerDexTricksterBal overrides SkillBonusDefensePerDexTrickster
{
	StatChangePerAttributeChange	1.0 // 0.75
}

SkillManaGenTricksterBal overrides SkillManaGenTrickster
{
	PowerGainOnHit		0.5 // 0
	PowerGainOnKill		3.0 // 0
	DynamicStatChangeInCombatPowerGainMult	0 // 0.5
}

SkillJabPerLevelBal overrides SkillJabPerLevel
{
	DamageMultPhysical	0.05 // 0.125
	DynamicStatChangeCriticalHit	0.8 // 0
	DynamicStatMultCriticalHit	0 // 0.05
}

SkillJabBal overrides SkillJab
{
	Power		12 // 15
	ReuseTime	4.5 // 0
